public class Foo2 {
    public static void main(String[] args) {
        ...
        //boolean can only be set to true and false
...
//        float f8 = _1000.000000f; //Underscore cannot be at start of literal
//        double l8 = 1.0000000_e10; //Underscore cannot prefix exponential in literal

            //Cannot set primitive value to null
//          int i9 = null;
//          double d9 = null;

            //Can only set boolean to true or false
//            boolean aBoolean = 0;
